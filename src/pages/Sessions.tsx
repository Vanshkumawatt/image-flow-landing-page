    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
      ...
      <main className="py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Popular Categories */}
          <div className="mb-12">
            <h2 className="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent mb-6">Popular Categories</h2>
            
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { name: 'Photography', icon: <BookIcon className="h-6 w-6" />, color: 'from-blue-500 to-indigo-500', count: 42 },
                { name: 'Editing', icon: <LightbulbIcon className="h-6 w-6" />, color: 'from-purple-500 to-pink-500', count: 28 },
                { name: 'Lighting', icon: <SparklesIcon className="h-6 w-6" />, color: 'from-indigo-500 to-purple-500', count: 35 },
                { name: 'Composition', icon: <LayoutGridIcon className="h-6 w-6" />, color: 'from-green-500 to-teal-500', count: 19 },
              ].map((category) => (
                  ...
                  <CardContent className="p-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">{category.count} sessions</p>
                      </div>
                    </div>
          ...
          <div className="mb-12">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">Featured Instructors</h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                { name: 'Sarah Johnson', role: 'Portrait Photographer', avatar: 'https://randomuser.me/api/portraits/women/32.jpg', rating: 4.8, students: 1240 },
                { name: 'David Lee', role: 'Visual Artist', avatar: 'https://randomuser.me/api/portraits/men/45.jpg', rating: 4.6, students: 890 },
                { name: 'Maya Patel', role: 'Professional Retoucher', avatar: 'https://randomuser.me/api/portraits/women/68.jpg', rating: 4.9, students: 1560 },
                { name: 'James Wilson', role: 'Landscape Photographer', avatar: 'https://randomuser.me/api/portraits/men/22.jpg', rating: 4.7, students: 1120 },
              ].map((instructor) => (
                <Card key={instructor.name} className="border-0 shadow-md hover:shadow-xl transition-all duration-300 group cursor-pointer overflow-hidden">
                  <CardContent className="p-5">
                    <div className="flex flex-col items-center text-center">
                      ...
                      <h3 className="font-medium text-gray-800 group-hover:text-indigo-600 transition-colors duration-300">{instructor.name}</h3>
                      <p className="text-xs text-gray-500 mb-2">{instructor.role}</p>
                      <div className="flex items-center gap-1 mb-2">
                        <div className="flex">
                          {[...Array(5)].map((_, i) => (
                            <StarIcon key={i} className={`h-3.5 w-3.5 ${i < Math.floor(instructor.rating) ? 'text-amber-400 fill-amber-400' : 'text-gray-300'}`} />
                          ))}
                        </div>
                        <span className="text-xs font-medium text-gray-700">{instructor.rating}</span>
                      </div>
                      <p className="text-xs text-indigo-600 font-medium">{instructor.students.toLocaleString()} students</p>
                    </div>
                  </CardContent>
                </Card>
              ))}
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-indigo-600 to-purple-600 p-8 text-white shadow-xl">
            ...
            <div className="absolute bottom-0 left-0 h-48 w-48 rounded-full bg-white/10 blur-3xl"></div>
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="max-w-2xl">
                <h2 className="mb-4 text-3xl font-bold tracking-tight">Become an Instructor</h2>
                <p className="mb-6 text-lg text-white/90">
                  Share your expertise with our community. Create engaging sessions, build your audience, and earn while teaching what you love.
                </p>
                <Button className="bg-white text-indigo-700 hover:bg-white/90 shadow-lg transition-all duration-300">
                  Apply Now
                </Button>
              </div>
              <div className="hidden md:block">
                <div className="w-48 h-48 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center">
                  <UserGroupIcon className="h-24 w-24 text-white/80" />
                </div>
              </div>
            </div>
          </div>
