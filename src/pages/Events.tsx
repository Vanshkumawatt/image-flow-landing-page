...
export default function Events() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
      ...
      <div className={`fixed inset-0 z-50 transition-all duration-300 ${sidebarOpen ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
        ...
        <div className={`absolute left-0 top-0 h-full w-[300px] bg-gradient-to-b from-indigo-100/95 via-purple-50/90 to-indigo-100/95 shadow-2xl backdrop-blur-sm transform transition-all duration-500 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} border-r border-indigo-200/30 rounded-r-3xl`}>
          ...
          <div className="absolute inset-0 overflow-hidden rounded-r-3xl">
            ...
            <div className="absolute h-60 w-60 bottom-20 -left-20 bg-indigo-300/30 rounded-full blur-3xl opacity-70"></div>
          ...
          <div className="py-6 px-4 space-y-4 relative z-10">
            <div className="space-y-2.5">
              <NavItem icon={<HomeIcon className="h-5 w-5" />} text="Dashboard" onClick={() => {
                navigate('/dashboard');
                window.scrollTo(0, 0);
                setSidebarOpen(false);
              }} />
              <NavItem icon={<CalendarIcon className="h-5 w-5" />} text="Events" active onClick={() => {
                window.scrollTo(0, 0);
                setSidebarOpen(false);
              }} />
              <NavItem icon={<BookOpenIcon className="h-5 w-5" />} text="Sessions" onClick={() => {
                navigate('/sessions');
                window.scrollTo(0, 0);
                setSidebarOpen(false);
              }} />
              <NavItem icon={<UsersIcon className="h-5 w-5" />} text="Community" onClick={() => {
                navigate('/community');
                window.scrollTo(0, 0);
                setSidebarOpen(false);
              }} />
              ...
              {eventData.map((event) => (
                ...
                >
                  ...
                  <CardContent className="p-4 sm:p-6">
                    <h3 className={`text-lg sm:text-xl font-bold mb-2 group-hover:text-${event.color}-600 transition-colors duration-500 line-clamp-1`}>{event.title}</h3>
                    
                    <p className="text-gray-600 text-sm mb-4 line-clamp-2">{event.description}</p>
                    
                    {/* Presenter info with enhanced styling */}
                    <div className={`flex flex-wrap items-center mb-4 p-2 bg-${event.color}-50/50 rounded-lg border border-${event.color}-100/50`}>
                      ...
                      <div className="min-w-0 flex-1">
                        <span className="text-xs font-medium text-gray-800 block truncate">{event.presenter.name}</span>
                        <span className="text-xs text-gray-500 block truncate">{event.presenter.role}</span>
                      </div>
                      <div className={`mt-2 sm:mt-0 ml-0 sm:ml-auto w-full sm:w-auto bg-white px-2 py-1 rounded-md text-xs font-medium text-${event.color}-600 shadow-sm border border-${event.color}-100/50 text-center`}>
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 mt-5 relative z-10">
                      ...
                      >
                        ...
                        <div className="flex items-center justify-center gap-2">
                          <span className="relative z-10 text-sm sm:text-base font-medium group-hover:tracking-wide transition-all duration-300">Register</span>
                      ...
                      <Button 
                        variant="outline" 
                        className={`flex-1 border-indigo-200 text-indigo-700 hover:bg-indigo-50 hover:border-indigo-300 transition-all duration-500 ease-in-out hover:scale-[1.05] rounded-xl py-4 sm:py-6 relative overflow-hidden group`}
                        onClick={() => {
                      ...
                      >
                        ...
                        {/* Icon and text with micro-interactions */}
                        <div className="flex items-center justify-center gap-2">
                          <span className="relative z-10 text-sm sm:text-base font-medium group-hover:tracking-wide transition-all duration-300">View Details</span>
      ...
      {isRegisterDialogOpen && selectedEvent && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center overflow-hidden">
          {/* Backdrop */}
          <div 
            className="fixed inset-0 bg-black/80 backdrop-blur-sm transition-opacity animate-in fade-in-0"
          ...
          {/* Modal Content */}
          <div 
            className="relative z-[101] w-[95%] md:w-full max-w-[500px] max-h-[90vh] overflow-y-auto bg-white rounded-2xl border-0 shadow-2xl p-0 animate-in fade-in-0 zoom-in-95 mx-auto my-auto"
            style={{ transform: 'translate(-50%, -50%)', left: '50%', top: '50%', position: 'fixed' }}
          >
            {/* Decorative elements */}
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden rounded-2xl pointer-events-none">
            ...
            <div className="p-6 pt-5 relative z-10">
              ...
              <div className="mb-6 space-y-4">
                <div className="p-4 bg-gradient-to-r from-indigo-50/80 to-purple-50/80 rounded-xl border border-indigo-100/80 shadow-sm relative overflow-hidden group hover:shadow-md transition-all duration-300 hover:-translate-y-0.5">
                  {/* Animated background elements */}
                  <div className="absolute -top-20 -right-20 w-40 h-40 bg-gradient-to-br from-indigo-200/30 to-purple-200/30 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                ...
                <div className="p-4 bg-gradient-to-r from-indigo-50/80 to-indigo-50/30 rounded-xl border border-indigo-100/80 shadow-sm relative overflow-hidden group hover:shadow-md transition-all duration-300 hover:-translate-y-0.5">
                  {/* Animated background elements */}
                  <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-gradient-to-tr from-indigo-200/30 to-purple-200/30 rounded-full blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              ...
              <AlertDialogFooter className="flex flex-col sm:flex-row gap-3 pt-3 border-t border-gray-100">
                <AlertDialogAction 
                  className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-600 text-white rounded-xl py-5 shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5 hover:scale-[1.02] relative overflow-hidden group"
                  onClick={() => {
                    // Here you would typically handle the registration process
                    // For now, we'll just close the dialog
                    setIsRegisterDialogOpen(false);
                    
                    // Set registration success and store the event
                    setRegistrationSuccess(true);
                    setRegisteredEvent(selectedEvent);
                  }}
                >
                  ...
                  <div className="flex items-center justify-center gap-2 relative z-10">
                    ...
                    <CheckCircle className="h-5 w-5 transform scale-0 group-hover:scale-100 transition-transform duration-300" />
                  </div>
                </AlertDialogAction>
              </AlertDialogFooter>
            </div>
      ...
      {registrationSuccess && registeredEvent && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center overflow-hidden">
          {/* Backdrop */}
          <div 
            className="fixed inset-0 bg-black/80 backdrop-blur-sm transition-opacity animate-in fade-in-0"
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              You have successfully registered for <span className="font-semibold text-indigo-700">{registeredEvent.title}</span> on {registeredEvent.date}.
            </p>
